...
{
    public partial class frmRepartiLibro : Form
    {
        bool seleziona = true;
        public frmRepartiLibro()
        {
            InitializeComponent();
        }
        ...
        private void frmRepartiLibro_Load(object sender, EventArgs e)
        {
            clsRepartiController listaReparti = new clsRepartiController();

            cmbReparti.DataSource = listaReparti.elencoReparti();
        ...
        private void cmbReparti_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbReparti.SelectedIndex != -1 && cmbReparti.ValueMember != string.Empty)
            {
                ...
                reparto.Reparto.DesReparto = cmbReparti.Text;
                ...
                if (!errore)
                {
                    ...
                    listaLibri.Libro.CodRepLibro = reparto.Reparto.CodReparto;

                    caricaElenco(listaLibri.elencoLibriRicercato());
        ...
        private void dgvLibri_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmbReparti.SelectedValue = dgvLibri.Rows[e.RowIndex].Cells[6].Value.ToString();
        ...
        private void btnConferma_Click(object sender, EventArgs e)
        {
            ...
            if (chkDatiLibro())
            {
                ...
                modLibro.Libro.CodRepLibro = cmbReparti.SelectedValue.ToString();
