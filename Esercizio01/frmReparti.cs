...
namespace Esercizio01
{
    public partial class frmReparti : Form
    {
        ...
        private void caricaReparti(List<clsReparto> lista)
        {
            // Carico la DGV
        ...
        private void btnConferma_Click(object sender, EventArgs e)
        {
            ...
            if (chkDatiReparti())
            {
                ...
                if (chkAnnullato.Checked)
                    insReparto.Reparto.ValReparto = 'A';
        ...
        private bool chkDatiReparti()
        {
            ...
            else
            {
                ...
                if (btnConferma.Text == "C O N F E R M A")
                {
                    // Controllo la duplicazione del Codice Libro
        ...
        {
            if (cmbReparti.SelectedIndex != -1 &&
                cmbReparti.ValueMember != string.Empty && seleziona)
            {
